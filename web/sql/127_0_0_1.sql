...
--
-- Host: 127.0.0.1
-- Tempo de geração: 24/06/2023 às 23:26
...
INSERT INTO `autor` (`idAutor`, `nome`, `biografia`, `sobrenome`) VALUES
(8, 'abel', 'foi um cara legal', 'jr');
...
INSERT INTO `exemplar` (`idExemplar`, `quantExemplar`, `conservacao`, `status`, `idLivro`) VALUES
(8, '1200', 'bom', 1, 11),
(9, '50', 'bom', 1, 12);
...
INSERT INTO `livro` (`idLivro`, `titulo`, `genero`, `local`, `pais`, `descFisica`, `ano`, `idioma`, `assunto`, `curso`, `cutter`, `tombamento`, `editora`, `isbn`) VALUES
(11, 'teste', 'te', 'dsadas', 'Brasil', 'bom', '2023-06-16', 'pt', 'infomaria', 'ti', 'naosei', 'noe', 'abel', '1231231341'),
(12, 'teste2', 'ew', 'ewq', 'Brasil', 'ewq', '2023-06-01', 'ewq', 'das', 'weq', 'dsa', 'fsa', 'eawed', '21331232132');
...
(6, 'Bibliotecario ', 'bibliotecario', '1234', 'bibli@gmail.com', '123456789', 1, 6);
...
--
ALTER TABLE `exemplar`
  MODIFY `idExemplar` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
('root', '[{\"db\":\"biblioteca\",\"table\":\"menu\"},{\"db\":\"biblioteca\",\"table\":\"menu_perfil\"},{\"db\":\"biblioteca\",\"table\":\"perfil\"},{\"db\":\"biblioteca\",\"table\":\"usuario\"},{\"db\":\"biblioteca\",\"table\":\"reserva\"},{\"db\":\"biblioteca\",\"table\":\"livro_autor\"},{\"db\":\"biblioteca\",\"table\":\"livro\"},{\"db\":\"biblioteca\",\"table\":\"exemplar\"},{\"db\":\"biblioteca\",\"table\":\"emprestimo\"},{\"db\":\"biblioteca\",\"table\":\"autor\"}]');
...
('root', '2023-06-24 21:25:52', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"pt_BR\"}');
