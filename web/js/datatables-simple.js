                        ...
                        T = function() {
                            ...
                            return t.prototype.init = function() {
                                ...
                                for (var a, o, r, l, d, c, h = function(t, e, s) {
                                    ...
                                    }(t, e, s), u = h.gaps1, p = h.gaps2, f = Math.min(u.length, p.length), m = [], g = 0, v = 0; g < f; v += 1, g += 1)
                                    if (!n || !0 !== u[g] && !0 !== p[g])
                                        if (!0 === u[g])
                                            if ("#text" === (l = t.childNodes[v]).nodeName)
                                                ...
                                                } else m.push((new N).setValue(this.options._const.action, this.options._const.removeTextElement).setValue(this.options._const.route, i.concat(g)).setValue(this.options._const.value, l.data)), u.splice(g, 1), f = Math.min(u.length, p.length), g -= 1;
                                else m.push((new N).setValue(this.options._const.action, this.options._const.removeElement).setValue(this.options._const.route, i.concat(g)).setValue(this.options._const.element, b(l))), u.splice(g, 1), f = Math.min(u.length, p.length), g -= 1;
                                else if (!0 === p[g]) "#text" === (l = e.childNodes[g]).nodeName ? (m.push((new N).setValue(this.options._const.action, this.options._const.addTextElement).setValue(this.options._const.route, i.concat(g)).setValue(this.options._const.value, l.data)), u.splice(g, 0, !0), f = Math.min(u.length, p.length), v -= 1) : (m.push((new N).setValue(this.options._const.action, this.options._const.addElement).setValue(this.options._const.route, i.concat(g)).setValue(this.options._const.element, b(l))), u.splice(g, 0, !0), f = Math.min(u.length, p.length), v -= 1);
                                else if (u[g] !== p[g]) {
                    ...
                    class tt {
                        ...
                        saveRow(t, e) {
                            ...
                            this.dt.data.data[this.data.rowIndex] = this.dt.data.data[this.data.rowIndex].map(((e, s) => {
                                ...
                                else if ("boolean" === i) o = ["", "false", "0"].includes(a) ? {
                                    data: !1,
                                    text: "false",
                                    order: 0
                                } : {
                    ...
                    s.DataTable = class {
                        constructor(t, e = {}) {
                            ...
                            this.options = {
                                ...
                                valueDiffing: !1
                            }), this.initialized = !1, this._events = {}, this._currentPage = 0, this.onFirstPage = !0, this.hasHeadings = !1, this.hasRows = !1, this._searchQueries = [], this.init()
                        }
                        init() {
                            ...
                            }, this.rows = new Q(this), this.columns = new Z(this), this.data = W(this.options.data, this.dom, this.columns.settings, this.options.type, this.options.format), this._render(), setTimeout((() => {
                        ...
                        if (a[0] = o, i.selection)
                            if (Array.isArray(i.selection))
                                for (let e = 0; e < i.selection.length; e++) a = a.concat(t.pages[i.selection[e] - 1].map((t => t.row.filter(((t, e) => n(e))).map((t => t.text ?? t.data)))));
                            else a = a.concat(t.pages[i.selection - 1].map((t => t.row.filter(((t, e) => n(e))).map((t => t.text ?? t.data)))));
                        else a = a.concat(t.data.data.map((t => t.filter(((t, e) => n(e))).map((t => t.text ?? t.data)))));
                        if (a.length) {
                            let t = "";
                            if (a.forEach((e => {
                                    e.forEach((e => {
                        ...
                        if (i.selection)
                            if (Array.isArray(i.selection))
                                for (let e = 0; e < i.selection.length; e++) a = a.concat(t.pages[i.selection[e] - 1].map((t => t.row.filter(((t, e) => n(e))).map((t => t.data)))));
