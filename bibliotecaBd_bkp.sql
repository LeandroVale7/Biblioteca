...
--
-- Host: 127.0.0.1
-- Tempo de geração: 28/06/2023 às 15:21
...
(15, 'Java para Web', 'ti', 'DF', 'Brasil', 'bom', '2007-06-13', 'PortuguÃªs ', 'Informatica', 'ti', '1234562432', '3214366432', 'Alta Books', '6060120301');
...
--
ALTER TABLE `emprestimo`
  MODIFY `idEmprestimo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT de tabela `exemplar`
--
ALTER TABLE `exemplar`
  MODIFY `idExemplar` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
('root', '2023-06-28 12:42:31', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"pt_BR\"}');
